...
#include "../Games_3_GL3.2_Template/glwidget.h"
...
QT_MOC_LITERAL(6, 75, 3)
    ...
    "GLWidget\0handle_open_clicked\0\0"
    "handle_reset_clicked\0wheelEvent\0"
    "QWheelEvent*\0evt"
};
...
void GLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { bool _r = _t->handle_open_clicked();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 1: { bool _r = _t->handle_reset_clicked();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
